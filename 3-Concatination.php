<?php
  ...
  // وهي الطريقة لجمع سلستين نصيتين أو أكثر في سلسلة واحدة.
    ...
    // لكن هذه الطريقة يدمج الاثنين بدون وجود اي فراغ بيهم
    ...
    // هذا الحالة مفيدة لان في حالة اللغة الانكليزية من نكتب نصوص ونختصر الكلمة نضطر نستخدمها
    // لكن يسبب النه مشكله فلازم بهذه طريقة نهملها حتى ماتاثر على الكود
