  ...
  // الي نعرفها يدوية وايضا تعتبر من الدوالة المهمة
  ...
  // 15 - array_rand()
  // هذه الدالة بسنتخدمها عندما نريد نختار قيم عشوائية بداخل مصفوفة عن طريق تمرير المصفوفة وعدد قيم الي نريدها
  ...
  // 17 - array_search()
  // دالة البحث تعتبر ايضا من دواله مهمه,
  ...
  // 19 - array_shift()
  // هذه الدالة يمسح قيمة الاول بداخل المصفوفة
  $firstValue = array_shift($arrPeople);
  //echo $firstValue;

  // 20 - array_pop()
  // هذه الدالة يحدف قيمة الاخيره بداخل المصفوفة
  $lastValue = array_pop($arrPeople);
  //echo $lastValue;

  // 21 - array_slice()
  // هذه الدالة ايضا تعتبر من الدوال المهمة, بحيث من نستطيع استرجاع قمية من اي مكان او نقطة نريدها
