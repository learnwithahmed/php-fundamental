...
# Data Type | انواع المتغيرات
  ...
  */
  ...
  $_cities1 = array('Kirkuk', 'Baghdad', 'Musul', 10); //we define array using array function;
  // او بستخدام الاقواس
  $_cities = ['Kirkuk', 'Baghdad', 'Musul', 10]; // we define array using brackets;
  ...
  // ولطبع اي قيمة بالمصفوفة فقط نكتب اسم المصفوفة وننطي رقم الاندكس اي يعني رقم موقع القيمة
  echo $_cities[0];
  ...
  #Associative Type;
  // نوع الثاني من المصفوفة يمكننا اعادة كتابة الاندكس يدوية
  ...
  // والطبع يكون نفس الشي, اول شي ننطي رقم اندكس اول موقع
